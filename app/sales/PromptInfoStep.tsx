        ...
        <div className='space-y-4'>
            ...
            <div>
                ...
                <textarea
                    ...
                    className='outline-none min-h-30 placeholder:text-gray-500 px-4.75 py-2.5 w-full border text-gray-800 disabled:bg-gray-300 border-gray-500 hover:border-gray-800 focus-within:border-primary-200 rounded-lg bg-gray-100 has-[input:disabled]:hover:border-gray-500'
                    placeholder="예: 해당 프롬프트는 별로 만들어진 동물이 밤하늘과 바다 위를 뛰어다니는 이미지를 생성한 프롬프트입니다."
                    value={promptDescription}
                    onChange={(e) => setPromptDescription(e.target.value)}
                    required
                />
                <span className="mt-2 typo-body2-regular text-gray-500">
            ...
            <div>
                <label htmlFor="sales-prompt-tag" className="mb-1.5 text-gray-800 typo-body1-semibold">
                    태그 추가
                </label>
                <TagInput
                    id="sales-prompt-tag"
                ...
                />
                <span className="mt-2 typo-body2-regular text-gray-500">
                    최소 2~ 최대 5개까지 등록이 가능해요. 태그는 띄어쓰기로 구분하며 최소 2자~ 최대 12자까지 입력할 수 있어요.
                </span>
            </div>
        </div>
    );
